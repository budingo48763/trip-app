...
def generate_google_map_route(items):
    ...
    # Google Maps Direction URL: https://www.google.com/maps/dir/Origin/Waypoint1/Waypoint2/Destination
...
st.markdown("""
    ...
    div[data-testid="stRadio"] label div[data-testid="stMarkdownContainer"] p {
        ...
        font-weight: 500 !important; color: #666 !important; line-height: 1.1 !important; margin: 0 !important;
    }
    ...
    .time-label {
        ...
        font-size: 0.95rem; font-weight: 900; color: #444; font-family: 'Times New Roman', sans-serif;
    }
    .connector-line {
    ...
    /* 地圖按鈕樣式 */
    .map-btn {
        text-decoration: none; color: #555; border: 1px solid #DDD; 
        padding: 2px 8px; border-radius: 12px; font-size: 0.75rem; 
        margin-left: 8px; background: #FAFAFA; display: inline-flex; align-items: center;
    }
    .map-btn:hover { background: #F0F0F0; border-color: #CCC; }
...
with tab1:
    ...
    if current_items:
        ...
        st.markdown(f"<div style='text-align:center;'><a href='{route_url}' target='_blank' style='background:#333; color:white; padding:10px 25px; border-radius:30px; text-decoration:none; font-weight:bold;'>🚗 開啟本日導航 (Google Maps)</a></div>", unsafe_allow_html=True)

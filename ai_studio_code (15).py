...
st.markdown("""
    ...
    /* 第一行字 (Day) */
    div[data-testid="stRadio"] label p::first-line {
    ...
    div[data-testid="stRadio"] label[data-checked="true"] p { color: #FFFFFF !important; }
    div[data-testid="stRadio"] label[data-checked="true"] p::first-line { color: rgba(255,255,255,0.8) !important; }
...
with tab1:
    ...
    for index, item in enumerate(current_items):
        ...
        # 卡片本體 (修正縮排問題)
        card_html = f"""<div style="position:relative;">

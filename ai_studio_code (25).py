...
with tab4:
    ...
    st.markdown(f"""<div class="info-card"><div class="info-header"><span>去程 {f['outbound']['date']}</span></div><div class="info-time">{f['outbound']['dep']} ➝ {f['outbound']['arr']}</div></div>""", unsafe_allow_html=True)
    st.markdown(f"""<div class="info-card"><div class="info-header"><span>回程 {f['inbound']['date']}</span></div><div class="info-time">{f['inbound']['dep']} ➝ {f['inbound']['arr']}</div></div>""", unsafe_allow_html=True)